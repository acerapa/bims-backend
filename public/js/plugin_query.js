(function (window) {
	...
	function PluginQuery() {
		...
		Plugin_query.deleteRecordWithPassword = function (table, whereArray, user_refid, password, callback) {

			var args 	= { table: table, where: whereArray, user_refid: user_refid, password: password };
			var uri 	= env_api + "api/plugin_query/deleteWithPassword?" + $.param(args);
