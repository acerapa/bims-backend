...
CREATE TABLE `plugin_store` (
  ...
  `loc_region` varchar(3) DEFAULT NULL,
  `loc_province` varchar(10) DEFAULT NULL,
  `loc_city` varchar(10) DEFAULT NULL,
  `loc_brgy` varchar(15) DEFAULT NULL,
  `order_cost_service_fee` decimal(10,2) NOT NULL DEFAULT 0.00,
  `created_at` datetime DEFAULT current_timestamp(),
  `created_by` varchar(22) DEFAULT NULL,
  `last_modefied` datetime DEFAULT NULL,
